  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">56457 Ratings</p>
        ...
        {/* rating and Review */}
        <section>
          <h1 className="flex font-semibold text-lg pb-4">
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                <h1 className="flex text-xl font-semibold pb-2">
                  {" "}
                  Product Rating
                </h1>
                <div className="flex items-center space-x-3">
                  <Rating value={4.6} precision={0.1} readOnly />
                  <h1 className="opacity-60"> 54545 ratings</h1>
                </div>
        ...
        <section className="pt-10">
          <h1 className="flex py-5 text-xl font-bold">Similar Products</h1>
          <div className="flex flex-wrap mx-5 space-x-5 space-y-5">
            {mens_kurta.map((item) => (
